      ...
      <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-white/40 font-body mt-1">Create your free account</p>
          </div>
          ...
          {success ? (
            ...
            <div className="glass rounded-2xl p-8 border border-green-500/20 text-center">
              ...
              <h2 className="font-display text-xl text-white font-bold mb-2">
                Check your email!
              </h2>
              <p className="text-white/50 font-body text-sm mb-4">
                We sent a verification link to:
              </p>
              <p className="text-brand-400 font-body text-sm font-medium mb-4">
                {form.email}
              </p>
              ...
              <Link
                href="/auth/login"
                className="inline-block mt-6 px-5 py-2.5 bg-brand-600 hover:bg-brand-500 text-white text-sm font-body rounded-xl transition-all"
              >
                Go to Sign In
              </Link>
            </div>
